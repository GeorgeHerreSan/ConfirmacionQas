...
public partial class Mantenedores_EditarCorreos : System.Web.UI.Page
{
    string Email;
    string Alias;
    string Estado;
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        string resultado = editarCorreos(Email, Alias, Estado, ID, Rut);

        Response.Clear();
        Response.Write(resultado);
    }

    public string editarCorreos(string Email, string Alias, string Estado, string ID, string Rut)
    {
        Correo objCorreo = new Correo();
        string resulta2;
        objCorreo.editarCorreos(Email, Alias, Estado, ID, Rut);
